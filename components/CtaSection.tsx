        ...
        <Card className="border border-slate-200 shadow-lg overflow-hidden bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="p-6 sm:p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12">
              ...
              {/* Perfect For */}
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                <h3 className="font-semibold text-lg sm:text-xl mb-6 text-slate-800">Perfect For:</h3>
            ...
            <div className="text-center">
              <a href="https://calendly.com/" target="_blank" rel="noopener noreferrer" className="inline-block">
               
              <Button
              variant="default"
              className="px-5 sm:px-7 py-4 md:py-7 tovoilet-400 bg-indigo-400 text-white rounded-2xl font-semibold text-sm md:text-base btn-cta group w-full"
            >
              <span className="flex items-center justify-center gap-3 btn-content">
                ...
                <span className="whitespace-nowrap md:text-lg text-md">Schedule Free Session</span>
              </span>
            </Button>
               
                {/* <Button className="px-6 py-6 text-white bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-600 hover:to-violet-600 rounded-full font-medium shadow-md hover:shadow-lg transition-all group">
              ...
              <p className="mt-6 text-sm text-slate-500">
                <span className="text-amber-500">✦</span> Limited slots available. Book now to secure your spot.
              </p>
            </div>
          </CardContent>
        </Card>
